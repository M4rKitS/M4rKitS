...
<img src="./banner.jpeg" alt="Marcos Rodríguez banner" width="100%" />
...
- 💼 Building **[M4rKitS.dev](https://m4rkits.dev)**, my freelance brand — websites and apps for small businesses and startups
...
- 📫 Reach me at **contact@m4rkits.dev**
...
I combine my formal training with **AI-assisted development tools** — mainly **Google Antigravity** — to design, build, and ship real products faster. I own the architecture decisions, the product calls, and the debugging; the tools help me execute. It's how I built everything you'll find below.
...
| **[M4rKitS.dev](https://m4rkits.dev)** | My personal freelance brand website | Cloudflare Pages · JS |
...
<img src="https://skillicons.dev/icons?i=html,css,js,react,vue,angular,astro,nodejs,django,java,rust,go,mysql,wordpress&theme=dark" />
...
<a href="mailto:contact@m4rkits.dev" target="_blank">
